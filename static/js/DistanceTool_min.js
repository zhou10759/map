var BMapLib = window.BMapLib = BMapLib || {}; (function () {
    ...
    d.prototype._processLastOp = function () {
        ...
        var m = this._opts.closeIcon ? this._opts.closeIcon : new BMap.Icon("http://api.map.baidu.com/images/mapctrls.gif", new BMap.Size(100, 12), {
            imageOffset: new BMap.Size(45, -14)
        });
