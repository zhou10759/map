<template>
    <div>
        ...
        <div class="message">
            <div class="user-inpt">
                <div class="inpt-list">
                    <input type="text" placeholder="请输入真实姓名" autocomplete="off" @blur="isName" id="name"
                        v-model="userName" />
                    <img src="../../../static/img/for.png" v-if="trueName==true" alt />
                    <p v-if="trueName==false">*</p>
                </div>
                <div ref="contName" class="cont-title"></div>
                <div class="inpt-list">
                    <input type="text" placeholder="请输入联系电话" autocomplete="off" @blur="isPhone" id="phone"
                        maxlength="11" v-model="userPhone" />
                    <img src="../../../static/img/for.png" v-if="truePhone==true" alt />
                    <p v-if="truePhone==false">*</p>
                </div>
                <div ref="contPhone" class="cont-title"></div>
                <div class="inpt-list">
                    <input type="text" placeholder="请输入邮箱" autocomplete="off" @blur="isEmail" id="e-mail"
                        v-model="userEmail" />
                    <img src="../../../static/img/for.png" alt v-if="trueEmail==true" />
                    <p v-if="trueEmail==false">*</p>
                </div>
                <div ref="contEmail" class="cont-title"></div>
                <div class="inpt-list">
                ...
                <div ref="contCompany" class="cont-title"></div>
                <div class="inpt-list">
                    <input type="text" placeholder="请输入品牌名称" autocomplete="off" @blur="isBrand" id="brand"
                        v-model="brand" />
                    <img src="../../../static/img/for.png" v-if="trueBrand==true" alt />
                    <p v-if="trueBrand==false">*</p>
                </div>
                <div ref="contBrand" class="cont-title"></div>
            </div>
            <!-- 上传图片 -->
        ...
        <div class="pop-up" v-if="isShow==true">
            ...
            <div class="success">账号申请成功，平台会线下联系您！<br>请在PC端登陆 </div>
        ...
        methods: {
            ...
            isName() {
                ...
                if (reg2.test(this.userName) == true) {
                    this.trueName = true;
                    this.$refs.contName.innerHTML = ''
                } else {
                    this.trueName = false;
                    this.$refs.contName.innerHTML = '请填写正确的姓名';
                }
            },
            // 校验电话
            isPhone() {
                ...
                if (reg.test(this.userPhone) == true) {
                    this.truePhone = true;
                    this.$refs.contPhone.innerHTML = '';
                } else {
                    this.truePhone = false;
                    this.$refs.contPhone.innerHTML = '请输入正确的手机号';
                }
            },
            // 校验邮箱
            isEmail() {
                ...
                if (reg.test(this.userEmail) == true) {
                    this.trueEmail = true;
                    this.$refs.contEmail.innerHTML = '';
                } else {
                    this.trueEmail = false;
                    this.$refs.contEmail.innerHTML = '请填写正确的邮箱地址';
                }
            },
            // 校验企业名称
            isCompany() {
                ...
                if (reg.test(this.company) == true) {
                    ...
                    this.$refs.contCompany.innerHTML = '';
                } else {
                    this.trueCompany = false;
                    this.$refs.contCompany.innerHTML = '请填写正确的企业名称(两个字以上（包含两个))';
                }
            },
            // 校验品牌名称
            isBrand() {
                ...
                if (this.brand) {
                    this.trueBrand = true;
                    this.$refs.contBrand.innerHTML = '';
                } else {
                    this.trueBrand = false;
                    this.$refs.contBrand.innerHTML = '请填写品牌名称(两个字以上（包含两个))';
                }
            }
        }
    };
